                    ...
                    <table class="w-full table-auto border-collapse">
                        ...
                        @forelse ($goldPrices as $price)
                            <tr class="center border-b dark:border-gray-700">
                                <td class="px-4 py-2">{{ strtoupper($price->karat) }}</td>
                                <td class="px-4 py-2">₱{{ number_format($price->price_per_gram, 2) }}</td>

                                <td class="text-center p-2 flex gap-2">
                                    <x-primary-button class="bg-green-500 p-1 hover:bg-green-600 text-white">
                                        <!-- Pencil icon -->
                                    ...
                                    <x-secondary-button class="bg-red-500 p-1 hover:bg-red-600 text-white">
                                        <!-- Trash icon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
